...
public class SamplePlayerFpsActivity extends Activity implements Runnable,
    ...
    private VideonaVideoView videoView;
    private VideonaVideoRender videoRender;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sample_player_fps);

        mPlaybackView = (TextureView) findViewById(R.id.PlaybackView);

        videoView = new VideonaVideoView(this);

        //surfaceTexture = videoView.getSurfaceTextureRenderer();
