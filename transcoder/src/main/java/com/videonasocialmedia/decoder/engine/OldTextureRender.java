 ...
 */
public class OldTextureRender {
    private static final String TAG = "OldTextureRender";
    ...
    public void surfaceCreated() {
        mProgram = createProgram(VERTEX_SHADER2, FRAGMENT_SHADER);
        if (mProgram == 0) {
