 ...
 */
public class DecoderTextureRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public DecoderTextureRender(OutputPlayerSurface outputSurface) {
