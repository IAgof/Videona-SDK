...
package com.videonasocialmedia.sdk.opengl;
...
import com.videonasocialmedia.sdk.overlay.Filter;
 ...
 */
public class OutputPlayerSurface implements SurfaceTexture.OnFrameAvailableListener {
     ...
     */
    public OutputPlayerSurface(int width, int height) {
        if (width <= 0 || height <= 0) {
     ...
     */
    public OutputPlayerSurface(Drawable drawable, List<Drawable> drawableList, SessionConfig config) {
    ...
    public OutputPlayerSurface() {

        this.config = new SessionConfig();

        eglSetup(config.getVideoWidth(), config.getVideoHeight());
        makeCurrent();
    ...
    public void setup() {
        ...
        synchronized (mSurfaceTextureFence) {
            ...
            mTextureRender = new DecoderTextureRender(this);
    ...
    public void setmTextureRender(DecoderTextureRender textureRender){
