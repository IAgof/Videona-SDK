 ...
 */
package com.videonasocialmedia.sdk.format;

import android.media.MediaCodecInfo;
import android.media.MediaFormat;

import com.videonasocialmedia.sdk.exceptions.OutputFormatUnavailableException;
...
public class VideonaMediaFormatPresets {
    private static final int LONGER_LENGTH_960x540 = 960;

    private VideonaMediaFormatPresets() {
    }
